...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/freephil-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11271&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/freephil-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `freephil` can be installed with:

```
conda install freephil
```

It is possible to list all of the versions of `freephil` available on your platform with:
